...
export default function MyBookingsScreen({ onBackToExperts }) {
  ...
  const [emailInput, setEmailInput] = useState(localStorage.getItem('clientEmail') || '')
  ...
  const loadBookings = async (bookingEmail) => {
    try {
      setLoading(true)
      ...
      <div className="my-bookings">
        ...
        <div className="email-search-card">
          ...
          <div className="email-search-form">
            ...
            />
            <button onClick={handleEmailSearch}>View Bookings</button>
          </div>
        </div>
      </div>
    )
